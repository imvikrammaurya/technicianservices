...
export default function Footer() {
  return (
    ...
    <footer className="bg-transparent mt-12 sm:mt-16">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-10 pb-4">
        <div className="border-t border-gray-600 pt-8">
          <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-12">
            <div className="flex flex-col lg:col-span-6">
              {/* Placeholder for Logo */}
              <div className="mb-4 font-bold text-xl text-blue-600">
                HomeTech
              </div>
              ...
              <p className="text-gray-600 text-sm leading-relaxed max-w-prose">
                ...
                washing machine, and water purifier servicing, Rajesh has built
                a reputation for honest work, accurate troubleshooting, and
                reliable home service. He believes in fixing problems the right
                way the first time.
              </p>
            </div>

            {/* Column 2: Links */}
            <div className="flex flex-col gap-2 items-start lg:col-span-3">
            ...
            <div className="flex flex-col lg:col-span-3">
              ...
              <img
                src={googleMapsImg}
                alt="Map preview"
                className="mt-4 w-full max-w-sm opacity-65 border border-gray-300 rounded-md"
                loading="lazy"
              />
            </div>
          </div>
